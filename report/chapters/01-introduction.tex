...
The market mechanisms consist of a Market Price Cap (MPC) of \$20,300/MWh and a cumulative price threshold (CPT), which is the maximum price across seven days' worth of trade at \$1,823,600/MWh from 1 July 2025 to 30 June 2026. This value is indexed to CPI each year by the Australian Energy Market Commission \cite{aemc_market_price_cap}. There are additional markets for ancillary services \cite{aemo_ancillary_services} that will not be addressed in this report but have the potential to be revenue streams for households participating in Virtual Power Plants and are regularly referenced in related literature.
