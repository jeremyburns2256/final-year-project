...
\begin{description}
  ...
  \item[$P_{max}$] The maximum charging/discharging rate from battery inverter (kW) 
...
of each time slot $n$. The regional system demand $S$ published by AEMO is likewise
...
The charge and discharge power at each time slot $n$ are determine
that maps the available system observations $\textbf{V}_n$ and pri
